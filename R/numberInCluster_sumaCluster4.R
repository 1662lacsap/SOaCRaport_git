#' Funkcja zliczajaca ilosc obserwacji w grupie 4
#' 
#' Funkcja numberInCluster_sumaALL(hc_data_infTrainCutree_) - oblicza ilosc obserwacji w grupie 4
#' 
#' @param hc_data_infTrainCutree_ Zbior danych
#' @author Czeslaw Horyn choryn@us.edu.pl
#' @export

 numberInCluster_sumaCluster4<-function(hc_data_infTrainCutree_)
 {
