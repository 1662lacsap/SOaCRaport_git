#' Funkcja zliczajaca ilosc obserwacji we wszystkich grupach lacznie
#' 
#' Funkcja numberInCluster_sumaALL(hc_data_infTrainCutree_) - oblicza ilosc obserwacji lacznie
#' 
#' @param hc_data_infTrainCutree_ Zbior danych
#' @author Czeslaw Horyn choryn@us.edu.pl
#' @export

 numberInCluster_sumaALL<-function(hc_data_infTrainCutree_)
 {
